...
<!-- 			<tr> -->
<!-- 				<td> -->
<%-- 				<button type="button" onclick="${adk:func('doApproves')}();" --%>
<!-- 					class="btn add">审批通过</button> -->
<!-- 				</td> -->
<!-- 			</tr> -->
<!-- 		</tbody> -->
<!-- 	</table> -->
...
<div class="table" id="listTablePoint"><display:table
		...
		<display:column title="操作" headerClass="ac" class="ac" style="width:100px;">
			<button type="button" class="btn edit"
								onclick="${adk:func('doApproves')}(${row.id});">审批</button>&nbsp;&nbsp;
			<button type="button" class="btn edit"
								onclick="${adk:func('doUnApproves')}(${row.id});">驳回</button>&nbsp;&nbsp;
		</display:column>
	</display:table>
</div>
...
$("#selectAll").selectAll({parentId:'listTablePoint'});
