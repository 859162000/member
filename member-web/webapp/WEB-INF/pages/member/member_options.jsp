...
<adk:form name="frmSearchExgPoint" action="doSearchExgPoint">
	<input type="hidden" name="id">
	<adk:func name="doSearchExgPoint" param="id" submit="yes" />
</adk:form> 
...
<adk:include var="memberExgPointlist" view="list" winlet="${m.memberExgPointLet}">t</adk:include>
	...
	<table border="0">
		<tbody>
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<button type="button" id="member_exg_point" onclick="${adk:func('doSearchExgPoint')}(${MEMBERMODEL.id });"
					class="btn search">会员积分账户</button>
				</td>
				<!--  
				<td align="left" nowrap="nowrap"> 
