...
<adk:form name="frmList" action="doDelete">
	...
	<div class="table" id="listTable"><display:table
		...
		<display:column sortProperty="startDtime" class="ac" sortable="true" title="积分规则开始时间" property="strStartDtime" value="${row.startDtime }">
		</display:column>
		<display:column sortProperty="endDtime" class="ac" sortable="true" title="积分规则结束时间" property="strEndDtime" value="${row.endDtime }">
		</display:column>
