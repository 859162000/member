...
<adk:form name="frmSearch" action="search">
	<table border="0">
		<tbody>
			<tr>
				<td align="right" nowrap="nowrap" width="80">波次名称:</td>
				<td align="left" nowrap="nowrap" width="180">
					<input:text name="activityName" class="txtinput_wid110"></input:text>
				</td>
				<td align="right" nowrap="nowrap" width="80">波次编码:</td>
				<td align="left" nowrap="nowrap" width="180">
					<input:text name="activityCode" class="txtinput_wid110"></input:text>
				</td>
...
<adk:include var="list" view="list"></adk:include>
<div>
	${list}
</div>