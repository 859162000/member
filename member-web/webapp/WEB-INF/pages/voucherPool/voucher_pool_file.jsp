...
<adk:include var="ticketList" view="ticketList" winlet="${m.voucherPoolDetailLet}">t</adk:include>
...
<div style="min-width: 650px">
	...
	<!-- 券信息 -->
							...
							<td align="center" nowrap="nowrap">
								<c:choose>
									...
									<c:otherwise>
										...
										<button type="button" id="deleteFile" class="btn clear notext delfile">删除</button>
									</div>
									</c:otherwise>
								</c:choose>
		...
		<div align="center" style="margin:10px 0 0 0">
			...
			<button type="button" id="saveVoucherPool" class="btn save" onclick="${adk:func('saveEdit')}()">保存</button>
