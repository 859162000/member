...
<adk:form name="frmCloseSelCriterial" action="closeSelCriterial">
	<adk:func name="closeSelCriterial" submit="yes" />
</adk:form> 
...
<div class="dcontent">
<adk:form name="frmList" action="saveCriterial">
	<div class="table" id="segmentListTable"><display:table
		...
		<display:column title="编码" sortProperty="c.code" sortable="true"  class="ac" property="code" />
		<display:column title="名称" sortProperty="c.name" sortable="true"  class="ac" property="name" />
	</display:table>
	</div>
	<div align="center">
	<button type="submit" class="btn save">保存</button>
	<button type="button" class="btn cancel" onclick="${adk:func('closeSelCriterial')}();">取消</button>
	</div>
</adk:form></div>
