...
<jsp:root version="2.1" xmlns="http://www.w3.org/1999/xhtml"
	...
	<jsp:directive.attribute name="emptyOption" required="false" />
	<jsp:directive.attribute name="emptyOptionLabel" required="false" />
			...
			<c:otherwise>
				<c:if test="${emptyOption}">
					<adk:element elm="option">
						<adk:attr name="value" value="" />
						<adk:attr name="selected" value="selected" test="${empty inp.value}" />
						${emptyOptionLabel}
					</adk:element>
				</c:if>
