...
<jsp:root version="2.1" xmlns="http://www.w3.org/1999/xhtml"
	...
	<adk:getinput var="inp" type="password" name="${name}" object="${object}" property="${property}" value="${value}" validate="${validate}" error="${error}" disabled="${disabled}">
	...
	<adk:element elm="input">
		<adk:attr name="type" value="password" />
