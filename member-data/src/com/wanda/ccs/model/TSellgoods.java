...
/**
 * TSellgoods generated by hbm2java
 */
@Entity
@Table(name = "T_SELLGOODS")
public class TSellgoods extends VersionableEntity implements
	...
	public TSellgoods(String name, String barcode, Integer price,
			String supplier, Long isdelete, Date updatetime, String shortname,
			String innercode, String goodstype) {
		this.name = name;
	...
	@SequenceGenerator(name = "generator", sequenceName = "S_T_SELLGOODS")
	@Id
