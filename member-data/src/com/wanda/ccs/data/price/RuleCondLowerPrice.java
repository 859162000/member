...
public class RuleCondLowerPrice extends RuleCond {
	...
	private int lowerPrice; // 最低票价的低于多少
	private int highPrice; // //最低票价的高于多少
	private int lprice; // 最低票价的从多少
	private int hprice; // 最低票价的到多少
	private String priceChoose; // 判断选择的RADIO

	public RuleCondLowerPrice(EnumRuleCondType dim) {
		super(dim);
	...
	public boolean matches(Map<String, Object> params) {
		Integer price = (Integer) params.get(RuleParamTypes.LOW_PRICE);
		if (price == null)
			return false;
