...
import com.wanda.ccs.model.ApprovableUVEntity;
import com.wanda.ccs.model.State;
import com.wanda.ccs.service.IApprovableUVService;
...
public abstract class BaseApprovableUVServiceImpl<T extends ApprovableUVEntity>
		extends BaseCrudServiceImpl<T> implements IApprovableUVService<T> {
	...
	public void submit(Long id) {
		T o = findById(id);
		if (o instanceof AbstractStateUVEntity) {
			((AbstractStateUVEntity) o).setState(((AbstractStateUVEntity) o)
