...
public interface MessageSendConf {
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ SQL string  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
		...
		*/
		final String INSERT_MESSAGE_SEND_LOG = "INSERT INTO MESSAGE_SEND_LOG (SEND_LOG_ID, SEND_STATUS, CREATE_DATE, UPDATE_DATE, START_TIME, END_TIME, SEGM_MESSAGE_ID, SEND_COUNT) VALUES (S_MESSAGE_SEND_LOG.NEXTVAL,?,?,?,?,?,?,?)";
		...
		* @Fields SAVE_MESSAGE : 新增SEGM_MESSAGE信息的SQL
		*/
		final String INSERT_BAOCUN_MESSAGE = "INSERT INTO SEGM_MESSAGE (SEGM_MESSAGE_ID, CONTENT, APPROVE_STATUS, SEGMENT_ID, SEND_TIME, CREATE_BY, CINEMA, AREA, UPDATE_BY, CREATE_DATE, UPDATE_DATE, NO_SEND_CAL, VERSION, SEND_STATUS, OCCUPIED, ALLOW_MODIFIER, APPROVER, BATCH_ID,WORD_CONTENT) VALUES (s_segm_message.NEXTVAL,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
