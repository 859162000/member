...
public class CriteriaQueryServiceImpl implements CriteriaQueryService {
	...
	public CriteriaResult getExtPointConSaleQuery(String criteriaJson) throws CriteriaParseException {
		List<ExpressionCriterion> criteria = JsonCriteriaHelper.parse(criteriaJson);
	...
	public CriteriaResult getExtPointTicketQuery(String criteriaJson) throws CriteriaParseException {
		List<ExpressionCriterion> criteria = JsonCriteriaHelper.parse(criteriaJson);
		Set<String> groupIds = getGroupIdSet(criteria);
