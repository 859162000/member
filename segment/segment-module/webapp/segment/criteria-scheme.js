...
$(function(){
	...
	var zTreeSetting = {	
		...
		callback: {
			onDblClick: function(event, treeId, treeNode) {
				if(treeNode != null) _t.addCriterion(schemeGrid, treeNode.inputId, rtScheme.change);
			},
	...
	addBtn.click(function() {
		...
		if(nodes.length == 0) {
			...
			$.each(nodes, function(idx, node) { _t.addCriterion(schemeGrid, node.inputId, rtScheme.change); });
		}
