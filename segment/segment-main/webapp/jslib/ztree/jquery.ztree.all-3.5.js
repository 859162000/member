...
(function($){
	...
	_setting = {
		...
		async: {
			enable: false,
			async: true, //By default, all requests are sent asynchronously (i.e. this is set to true by default). Added by Charlie Zhang(2013-07-18)
	...
	view = {
		...
		asyncNode: function(setting, node, isSilent, callback) {
			...
			$.ajax({
				...
				async: setting.async.async, //Added by Charlie Zhang(2013-07-18)
