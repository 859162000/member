...
/*	public static final String MEMBER_VOUCHER_REL="select p.PRINT_CODE," +
	...
	"to_char(o.SALE_DATE,'yyyy-mm-dd hh24:mi:ss') AS SALE_DATE,"+ 
	"to_char(o.EXPIRY_DATE,'yyyy-mm-dd hh24:mi:ss') AS EXPIRY_DATE,"+ 
	"t.TYPE_CODE,t.TYPE_NAME,t.USE_TYPE, m.member_no, p.OPERRATE_TYPE, a.SHOW_VALUE as UNIT_VALUE ,a.MIN_PRICE,a.use_default "+ 
...
//	public static final String CHECK_VOUCHER_="";
	...
	public static final String INSERT_MEMBER_VOUCHER_REL="INSERT INTO T_VOUCHER_POOL_DETAIL(VOUCHER_POOL_DETAIL_ID, VOUCHER_POOL_ID, PRINT_CODE, BAR_CODE, MEMBER_ID, OPERRATE_TYPE,UPDATE_DATE) VALUES(S_T_VOUCHER_POOL_DETAIL.NEXTVAL, -1, ?, ?, ?, ?,sysdate)";
	public static final String DELETE_MEMBER_VOUCHER_REL="UPDATE T_VOUCHER_POOL_DETAIL SET MEMBER_ID=null,UPDATE_DATE=sysdate WHERE BAR_CODE =?";
	public static final String UPDATE_MEMBER_VOUCHER_REL="UPDATE T_VOUCHER_POOL_DETAIL SET MEMBER_ID=?, OPERRATE_TYPE=?,UPDATE_DATE=sysdate WHERE BAR_CODE =?";
