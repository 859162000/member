...
public class SqlMain {
	public static void main(String[] args){
		String numsql =	 "  SELECT  sum(RECRUIT_MEMBER_COUNT) NEWMEMBERS    "    // 新增会员数   
				...
				+"and b.STATUS_CODE = '1'                                                                                 ";        //
		System.out.println("新增会员数   =="+numsql);
...
//			+"------------------------------------------------                                                   "        //
			...
			System.out.println("新增票房数   =="+ticketsql);
...
//			+"----------------------------------------------------------------------------------                 "        //
			...
			System.out.println("新增卖品数   =="+goodssql);
			...
			System.out.println("积分品数   =="+pointsql);
...
//			+"----------------------------------------------------------------------------                       "        //
			...
			System.out.println("累计积分   =="+countsql);
...
//			+"-------------------------------------------------------------------------                          "        //
			...
			System.out.println("可兑换积分兑换   =="+exchangePointsql);
			...
			System.out.println("可兑换积分增加  =="+exchangePointnewsql);
			//可兑换积分余额：78524872
			...
			System.out.println("可兑换积分余额  =="+exchangePointBalancesql);
			//会员月票房累计，以后分线上，线下
			...
			System.out.println("会员月票房累计  =="+ticketMonthsql);
			...
			System.out.println("会员年票房累计  =="+ticketYearsql);
