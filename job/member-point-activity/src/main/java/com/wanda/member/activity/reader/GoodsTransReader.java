...
public class GoodsTransReader<T> extends JdbcCursorItemReader<T>{
    ...
    public void retrieveInterstepData(StepExecution stepExecution) {
        ...
        List<ActivityPointRuleSql> ticketSqlList = (List<ActivityPointRuleSql>)jobContext.get(RuleTypeConts.GOODS_RULE + CONTEXT_KEY_SUFFIX);
