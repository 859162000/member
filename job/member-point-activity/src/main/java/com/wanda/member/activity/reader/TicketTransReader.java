...
public class TicketTransReader<T> extends JdbcCursorItemReader<T>{
    ...
    public void retrieveInterstepData(StepExecution stepExecution) {
        ...
        List<ActivityPointRuleSql> ticketSqlList = (List<ActivityPointRuleSql>)jobContext.get(RuleTypeConts.TICKET_RULE + CONTEXT_KEY_SUFFIX);
