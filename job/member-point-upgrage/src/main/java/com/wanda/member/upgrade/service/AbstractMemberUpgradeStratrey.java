...
public abstract class AbstractMemberUpgradeStratrey extends MyBatisDAO  implements MemberUpgradeStrategy  {
	...
	protected boolean isSameLevel(TMemberLevel memberLevel) {
		return memberLevel.getMemLevel().equals(String.valueOf(getMemberLevel()));
	}
...
//		record.setSetTime(now);
		record.setUpdateDate(yesterday);
