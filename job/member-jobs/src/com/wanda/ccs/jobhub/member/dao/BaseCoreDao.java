...
public class BaseCoreDao  {
	...
	public Long getMemberPointBalance(Long memberId) {
		String sql = "select t.exg_point_balance from T_MEMBER_POINT t where t.member_id=?";
		return getJdbcTemplate().queryForLong(sql, new Object[] {memberId});
	}
